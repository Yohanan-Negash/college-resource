          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8'>
            <div className='space-y-6 lg:space-y-8 sm:mt-8'>
              <div className='group bg-[#2A2D3E]/50 backdrop-blur-sm p-6 lg:p-8 rounded-xl border border-zinc-700/50 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 cursor-pointer'>
                <Code
                  ...
                  size={28}
                />
                <h3 className='font-semibold text-xl mb-3 group-hover:text-purple-400 transition-colors'>
                  Hackathons
                </h3>
                <p className='text-zinc-400 group-hover:text-zinc-300 transition-colors'>
                  Connect with peers and showcase your skills through exciting
                  challenges
                </p>
              </div>
              ...
              <div className='group bg-[#2A2D3E]/50 backdrop-blur-sm p-6 lg:p-8 rounded-xl border border-zinc-700/50 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 cursor-pointer'>
                ...
                <p className='text-zinc-400 group-hover:text-zinc-300 transition-colors'>
                  Access curated learning resources and development
                  opportunities
                </p>
              </div>
            </div>
            ...
            <div className='space-y-6 lg:space-y-8'>
              <div className='group bg-[#2A2D3E]/50 backdrop-blur-sm p-6 lg:p-8 rounded-xl border border-zinc-700/50 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 cursor-pointer'>
                ...
                <p className='text-zinc-400 group-hover:text-zinc-300 transition-colors'>
                  Find opportunities at top companies and start your career
                  journey
                </p>
              </div>
              ...
              <div className='group bg-[#2A2D3E]/50 backdrop-blur-sm p-6 lg:p-8 rounded-xl border border-zinc-700/50 hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 cursor-pointer'>
                ...
                <p className='text-zinc-400 group-hover:text-zinc-300 transition-colors'>
                  Build your path to success with mentorship and guidance
                </p>
              </div>
            </div>
          </div>
