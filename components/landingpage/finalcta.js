    ...
    return (
        <div className="mt-20 mb-20">
            <div className="text-center">
                <h2 className="font-ubuntu text-4xl font-bold mb-6 text-white">{ctaContent.title}</h2>
                ...
                <p className="font-ubuntu text-sm text-zinc-400 mt-4">{ctaContent.footnote}</p>
            </div>
        </div>
    );
};
