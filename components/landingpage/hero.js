    ...
    <div className='items-center justify-center text-center py-2'>
      <div className='space-y-6 lg:space-y-8 max-w-3xl mx-auto px-4'>
        ...
        <p className='font-ubuntu text-zinc-400 text-lg lg:text-xl leading-relaxed'>
          This was a project we had fun working on and are very happy with the outcome. 
          Unfortunately, it didn't seem feasible to maintain. The platform has been archived, 
          but we're proud of what we built and the journey it represents.
        </p>
